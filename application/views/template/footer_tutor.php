...
<script src="<?= base_url()?>/assets_admin/js/charts-home.js"></script>
...
<link rel="shortcut icon" type="image/x-icon" href="<?= base_url()?>/assets_admin1/<?= base_url()?>/assets_admin1/img/favicon.ico">
    ...
    <!-- jquery
		============================================ -->
        <script src="<?= base_url()?>/assets_admin1/js/vendor/jquery-1.12.4.min.js"></script>
    <!-- bootstrap JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/bootstrap.min.js"></script>
    <!-- wow JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/wow.min.js"></script>
    <!-- price-slider JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/jquery-price-slider.js"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/jquery.meanmenu.js"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/owl.carousel.min.js"></script>
    <!-- sticky JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/jquery.sticky.js"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/jquery.scrollUp.min.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/scrollbar/mCustomScrollbar-active.js"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/metisMenu/metisMenu.min.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/metisMenu/metisMenu-active.js"></script>
    <!-- data table JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/data-table/bootstrap-table.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/data-table/tableExport.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/data-table/data-table-active.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/data-table/bootstrap-table-editable.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/data-table/bootstrap-editable.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/data-table/bootstrap-table-resizable.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/data-table/colResizable-1.5.source.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/data-table/bootstrap-table-export.js"></script>
    <!--  editable JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/editable/jquery.mockjax.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/editable/mock-active.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/editable/select2.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/editable/moment.min.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/editable/bootstrap-datetimepicker.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/editable/bootstrap-editable.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/editable/xediable-active.js"></script>
    <!-- Chart JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/chart/jquery.peity.min.js"></script>
    <script src="<?= base_url()?>/assets_admin1/js/peity/peity-active.js"></script>
    <!-- tab JS
		============================================ -->
    <script src="<?= base_url()?>/assets_admin1/js/tab.js"></script>
    <!-- plugins JS
		============================================ -->
