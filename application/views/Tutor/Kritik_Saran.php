                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                              ...
                              <li><span class="bread-blod">Kritik dan Saran</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php endif; ?>
                ...
                <input type="hidden" class="form-control" id="id_user" name="id_user" value="<?= $this->session->userdata('id_mahasiswa');?>">
